...
class Component extends PageLogic {
  ...
  renderVals() {
    return {
      ...
      heroStats: [
        { value: '10 m', label: 'Shooting distance' },
        { value: '53′', label: 'DOT-approved trailer' },
        { value: 'Zero', label: 'Surface danger zone' },
        { value: '99.97%', label: 'HEPA-filtered exhaust' }
      ],
      sectionNav: [
      ...
      features: [
        { n: '01', text: '360 degree containment with AR500 armor plate steel provides Zero-Surface-Danger-Zone' },
        { n: '02', text: '100% purge-only ventilation system with 99.97% HEPA-filtered exhaust. Recirc/AC available.' },
        { n: '03', text: '14” ballistic rubber block trap backed with ½” AR500 armor plate rated for ball ammunition 7.62mm x 51' },
        { n: '04', text: 'Fully insulated (thermal/acoustical)' },
        { n: '05', text: 'Double air wall ensures shooter air quality and quick contaminant removal' },
        { n: '06', text: 'Exclusive Thermal Shot™ Live-fire Simulator System' },
        { n: '07', text: 'DOT-approved tandem axle chassis' }
      ],
      operatorStation: ['Two-way intercom system', 'Targetry controls', 'Ventilation and lighting system controls', 'Shore power connection'],
      options: [
        { tag: 'Climate', text: 'Dual-mode (purge/recirculating) HVAC with heat and air conditioning, 99.97% HEPA-filtered exhaust/return' },
        { tag: 'Bullet trap', text: 'Inclined granular rubber bullet trap system' },
        { tag: 'Distance', text: 'Extended Target Distance (25m Max)' },
        { tag: 'Lanes', text: 'Two or three lane target retrieval system with shooting booths (not available in 40’ unit)' },
        { tag: 'Power', text: 'On-board sound attenuated diesel generator — and many more available upon request' }
      ],
      details: ['Wireless position tracking', 'Closed Circuit TV', 'Enhanced AAR with flagging', 'Force feedback options', 'Free-standing animated middle space targets', 'Biometric feedback and recording in real-time']
    };
  }
}


const app=new Component({});const bindings=[{"id":"1","kind":"text","expr":"\"{{ phone }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[]},{"id":"2","kind":"text","expr":"\"{{ stat.value }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"stat","expr":"heroStats","index":0}]},{"id":"3","kind":"text","expr":"\"{{ stat.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"stat","expr":"heroStats","index":0}]},{"id":"4","kind":"text","expr":"\"{{ stat.value }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"stat","expr":"heroStats","index":1}]},{"id":"5","kind":"text","expr":"\"{{ stat.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"stat","expr":"heroStats","index":1}]},{"id":"6","kind":"text","expr":"\"{{ stat.value }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"stat","expr":"heroStats","index":2}]},{"id":"7","kind":"text","expr":"\"{{ stat.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"stat","expr":"heroStats","index":2}]},{"id":"8","kind":"text","expr":"\"{{ stat.value }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"stat","expr":"heroStats","index":3}]},{"id":"9","kind":"text","expr":"\"{{ stat.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"stat","expr":"heroStats","index":3}]},{"id":"10","kind":"attribute","expr":"item.href","scopes":[{"as":"item","expr":"sectionNav","index":0}],"attr":"href"},{"id":"11","kind":"text","expr":"\"{{ item.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"item","expr":"sectionNav","index":0}]},{"id":"12","kind":"attribute","expr":"item.href","scopes":[{"as":"item","expr":"sectionNav","index":1}],"attr":"href"},{"id":"13","kind":"text","expr":"\"{{ item.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"item","expr":"sectionNav","index":1}]},{"id":"14","kind":"attribute","expr":"item.href","scopes":[{"as":"item","expr":"sectionNav","index":2}],"attr":"href"},{"id":"15","kind":"text","expr":"\"{{ item.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"item","expr":"sectionNav","index":2}]},{"id":"16","kind":"attribute","expr":"item.href","scopes":[{"as":"item","expr":"sectionNav","index":3}],"attr":"href"},{"id":"17","kind":"text","expr":"\"{{ item.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"item","expr":"sectionNav","index":3}]},{"id":"18","kind":"attribute","expr":"item.href","scopes":[{"as":"item","expr":"sectionNav","index":4}],"attr":"href"},{"id":"19","kind":"text","expr":"\"{{ item.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"item","expr":"sectionNav","index":4}]},{"id":"20","kind":"attribute","expr":"item.href","scopes":[{"as":"item","expr":"sectionNav","index":5}],"attr":"href"},{"id":"21","kind":"text","expr":"\"{{ item.label }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"item","expr":"sectionNav","index":5}]},{"id":"22","kind":"text","expr":"\"{{ f.n }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":0}]},{"id":"23","kind":"text","expr":"\"{{ f.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":0}]},{"id":"24","kind":"text","expr":"\"{{ f.n }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":1}]},{"id":"25","kind":"text","expr":"\"{{ f.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":1}]},{"id":"26","kind":"text","expr":"\"{{ f.n }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":2}]},{"id":"27","kind":"text","expr":"\"{{ f.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":2}]},{"id":"28","kind":"text","expr":"\"{{ f.n }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":3}]},{"id":"29","kind":"text","expr":"\"{{ f.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":3}]},{"id":"30","kind":"text","expr":"\"{{ f.n }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":4}]},{"id":"31","kind":"text","expr":"\"{{ f.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":4}]},{"id":"32","kind":"text","expr":"\"{{ f.n }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":5}]},{"id":"33","kind":"text","expr":"\"{{ f.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":5}]},{"id":"34","kind":"text","expr":"\"{{ f.n }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":6}]},{"id":"35","kind":"text","expr":"\"{{ f.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"f","expr":"features","index":6}]},{"id":"36","kind":"text","expr":"\"{{ o }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"operatorStation","index":0}]},{"id":"37","kind":"text","expr":"\"{{ o }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"operatorStation","index":1}]},{"id":"38","kind":"text","expr":"\"{{ o }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"operatorStation","index":2}]},{"id":"39","kind":"text","expr":"\"{{ o }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"operatorStation","index":3}]},{"id":"40","kind":"text","expr":"\"{{ o.tag }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":0}]},{"id":"41","kind":"text","expr":"\"{{ o.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":0}]},{"id":"42","kind":"text","expr":"\"{{ o.tag }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":1}]},{"id":"43","kind":"text","expr":"\"{{ o.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":1}]},{"id":"44","kind":"text","expr":"\"{{ o.tag }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":2}]},{"id":"45","kind":"text","expr":"\"{{ o.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":2}]},{"id":"46","kind":"text","expr":"\"{{ o.tag }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":3}]},{"id":"47","kind":"text","expr":"\"{{ o.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":3}]},{"id":"48","kind":"text","expr":"\"{{ o.tag }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":4}]},{"id":"49","kind":"text","expr":"\"{{ o.text }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"o","expr":"options","index":4}]},{"id":"50","kind":"text","expr":"\"{{ d }}\\n            \".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"d","expr":"details","index":0}]},{"id":"51","kind":"text","expr":"\"{{ d }}\\n            \".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"d","expr":"details","index":1}]},{"id":"52","kind":"text","expr":"\"{{ d }}\\n            \".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"d","expr":"details","index":2}]},{"id":"53","kind":"text","expr":"\"{{ d }}\\n            \".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"d","expr":"details","index":3}]},{"id":"54","kind":"text","expr":"\"{{ d }}\\n            \".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"d","expr":"details","index":4}]},{"id":"55","kind":"text","expr":"\"{{ d }}\\n            \".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[{"as":"d","expr":"details","index":5}]},{"id":"56","kind":"text","expr":"\"Call {{ phone }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[]},{"id":"57","kind":"text","expr":"\"{{ phone }}\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[]},{"id":"58","kind":"text","expr":"\"© {{ year }} Shooting Range Technologies™, a division of Laser Shot, Inc. All rights reserved.\".replace(/{{([\\s\\S]*?)}}/g, (_,e)=>evaluate(e,scope)?? \"\")","scopes":[]}];
